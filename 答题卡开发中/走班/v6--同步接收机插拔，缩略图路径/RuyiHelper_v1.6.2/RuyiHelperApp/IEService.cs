...
namespace RueHelper
{
    ...
    public interface IEService
    {
        ...
        [OperationContract]
        [WebInvoke(Method = "GET", ResponseFormat = WebMessageFormat.Json)]
        string ProjectiveInPPT(string courseid, string classid, string lessonid);

        [OperationContract]
        [WebInvoke(Method = "GET", ResponseFormat = WebMessageFormat.Json)]
        string JudgeProjectiveInPPT(string courseid, string classid, string lessonid);
        ...
        [OperationContract]
        [WebInvoke(Method = "GET", ResponseFormat = WebMessageFormat.Json)]
        string EnterKQ(string numData, string wrongName);
