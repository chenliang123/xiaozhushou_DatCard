...
namespace RueHelper
{
    ...
    class Global
    {
        ...
        public static bool isNetOk = true;
        ...
        public static string roomname = ""; //教室名称
        public static string classname = "";//教学班名称
        public static string teachername = "";//教师名称
        
        public static string RaiseStu = "";
        public static string AnswerStu = "";
        public static string judgeAnsewer = "R";
        public static string stuKQlist = ""; //考勤学生列表
        public static string lessonindex = ""; //教室课程节数
        public static string stuPadall = ""; //PAD交互考勤学生列表，有没上课需要一直变化：stuPadall = stuKQlist + stuPadon
        public static string stuPadon = ""; //记录pad点上课注册学生

        public static string g_roommsg = ""; //后台获取教室上课信息
        ...
        public static bool setSeatBtn = false;   //是否进入设置绑定座位页面
        ...
        public static bool g_haslessonOff = false;  //是否点过下课
...
///            loadClassInfo();
        ...
        public static string getSeatByCardid(string cardid)
        {
...
///                    break;
        ...
        public static int loadSchoolInfo(int schoolid,string authcode)
        {
            ...
            string strSchoolStuInfo = Common.getnewSchoolinfo(schoolid, authcode);
            addAllStuToLocal(strSchoolStuInfo);
