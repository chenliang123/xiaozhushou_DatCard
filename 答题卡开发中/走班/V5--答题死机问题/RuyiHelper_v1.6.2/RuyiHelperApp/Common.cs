...
namespace RueHelper
{
    ...
    class Common
    {
        ...
        //上传白名单中学生考勤信息到后台
        public static void uploadAllKQinfor(int schoolid , int classid ,string lessonnum,int hdid,string msg)
        {
            ////异步同步到云服务
        ...
        //上传白名单中学生考勤信息到后台
        public static void uploadPerKQinfor(int schoolid,int classid,string lessonnum, int hdid,string clocktime, string cardid)
        {
            ////异步同步到云服务
            string data = "schoolid=" + schoolid;
            data += "&classid=" + classid;
